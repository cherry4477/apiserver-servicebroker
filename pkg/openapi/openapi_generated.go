...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingService": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingService",
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceSpec", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstance": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceInstance",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceSpec", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstance"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstance", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceSchemeFns": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceInstance Functions and Structs",
					Properties: map[string]spec.Schema{
						"DefaultSchemeFns": {
							SchemaProps: spec.SchemaProps{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceInstanceSpec defines the desired state of BackingServiceInstance",
					Properties: map[string]spec.Schema{
						"provisioning": {
							SchemaProps: spec.SchemaProps{
								Description: "description of an instance.",
								Ref:         ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceProvisioning"),
							},
						},
						"userprovidedservice": {
							SchemaProps: spec.SchemaProps{
								Description: "description of an user-provided-service",
								Ref:         ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.UserProvidedService"),
							},
						},
						"binding": {
							SchemaProps: spec.SchemaProps{
								Description: "bindings of an instance",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceBinding"),
										},
									},
								},
							},
						...
						"bound": {
							SchemaProps: spec.SchemaProps{
								Description: "binding number of an instance",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceBinding", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceProvisioning", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.UserProvidedService"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceInstanceStatus defines the observed state of BackingServiceInstance",
					Properties: map[string]spec.Schema{
						"phase": {
							SchemaProps: spec.SchemaProps{
								Description: "phase is the current lifecycle phase of the instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"action": {
							SchemaProps: spec.SchemaProps{
								Description: "action is the action of the instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"patch": {
							SchemaProps: spec.SchemaProps{
								Description: "updating an instance need an flag.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"last_operation": {
							SchemaProps: spec.SchemaProps{
								Description: "last operation  of a instance provisioning",
								Ref:         ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.LastOperation"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.LastOperation"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceStatusStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceInstanceStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingService"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingService", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceSchemeFns": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingService Functions and Structs",
					Properties: map[string]spec.Schema{
						"DefaultSchemeFns": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/kubernetes-incubator/apiserver-builder/pkg/builders.DefaultSchemeFns"),
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceSpec defines the desired state of BackingService",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
								Description: "name of backingservice",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"id": {
							SchemaProps: spec.SchemaProps{
								Description: "id of backingservice",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"bindable": {
							SchemaProps: spec.SchemaProps{
								Description: "is backingservice bindable",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
						"plan_updateable": {
							SchemaProps: spec.SchemaProps{
								Description: "is  backingservice plan updateable",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
						"tags": {
							SchemaProps: spec.SchemaProps{
								Description: "list of backingservice tags of BackingService",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"requires": {
							SchemaProps: spec.SchemaProps{
								Description: "require condition of backingservice",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"metadata": {
							SchemaProps: spec.SchemaProps{
								Description: "metadata of backingservice",
								Type:        []string{"object"},
						...
						"plans": {
							SchemaProps: spec.SchemaProps{
								Description: "plans of a backingservice",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlan"),
										},
									},
								},
							},
						...
						"dashboard_client": {
							SchemaProps: spec.SchemaProps{
								Description: "DashboardClient of backingservic",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
					...
					Required: []string{"name", "id", "description", "bindable", "plans", "dashboard_client"},
				},
			},
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlan"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "BackingServiceStatus defines the observed state of BackingService",
					Properties: map[string]spec.Schema{
						"phase": {
							SchemaProps: spec.SchemaProps{
								Description: "phase is the current lifecycle phase of the servicebroker",
								Type:        []string{"string"},
								Format:      "",
							},
						},
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceStatusStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"DefaultStatusStorageStrategy": {
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BackingServiceStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"DefaultStorageStrategy": {
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.Binding": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"bindKind": {
							SchemaProps: spec.SchemaProps{
								Description: "bind kind is bindking of an instance binding",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"bindResourceVersion": {
							SchemaProps: spec.SchemaProps{
								Description: "bindResourceVersion is bindResourceVersion of an instance binding.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"resourceName": {
							SchemaProps: spec.SchemaProps{
								Description: "resourceName of an instance binding",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"parameters": {
							SchemaProps: spec.SchemaProps{
								Description: "parameters of a binding request",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BindingBackingServiceInstanceREST": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"Registry": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd.BackingServiceInstanceRegistry"),
							},
						},
					},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd.BackingServiceInstanceRegistry"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.BindingList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.Binding"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.Binding", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.CustomizeSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"default": {
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceBinding": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "InstanceBinding describe an instance binding.",
					Properties: map[string]spec.Schema{
						"bound_time": {
							SchemaProps: spec.SchemaProps{
								Description: "bound time of an instance binding",
								Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
							},
						},
						"bind_uuid": {
							SchemaProps: spec.SchemaProps{
								Description: "bind uid of an instance binding",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"bind_deploymentconfig": {
							SchemaProps: spec.SchemaProps{
								Description: "deploymentconfig of an binding.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"bind_hadoop_user": {
							SchemaProps: spec.SchemaProps{
								Description: "bind to hadoopuser",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"credentials": {
							SchemaProps: spec.SchemaProps{
								Description: "credentials of an instance binding",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.InstanceProvisioning": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "InstanceProvisioning describe an InstanceProvisioning detail",
					Properties: map[string]spec.Schema{
						"dashboard_url": {
							SchemaProps: spec.SchemaProps{
								Description: "dashboard url of an instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"backingservice_name": {
							SchemaProps: spec.SchemaProps{
								Description: "bs name of an instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"backingservice_spec_id": {
							SchemaProps: spec.SchemaProps{
								Description: "bs id of an instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"backingservice_plan_guid": {
							SchemaProps: spec.SchemaProps{
								Description: "bs plan id of an instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"backingservice_plan_name": {
							SchemaProps: spec.SchemaProps{
								Description: "bs plan name of an instance",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"parameters": {
							SchemaProps: spec.SchemaProps{
								Description: "parameters of an instance",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"credentials": {
							SchemaProps: spec.SchemaProps{
								Description: "credentials of an instance",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"accesses": {
							SchemaProps: spec.SchemaProps{
								Description: "access of hadoop insance... hardcode hack.",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.LastOperation": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "LastOperation describe last operation of an instance provisioning",
					Properties: map[string]spec.Schema{
						"state": {
							SchemaProps: spec.SchemaProps{
								Description: "state of last operation",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"async_poll_interval_seconds": {
							SchemaProps: spec.SchemaProps{
								Description: "async_poll_interval_seconds of a last operation",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
					},
					Required: []string{"state", "description"},
				},
			},
			Dependencies: []string{},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBroker": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerSpec", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBroker"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBroker", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerSchemeFns": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServiceBroker Functions and Structs",
					Properties: map[string]spec.Schema{
						"DefaultSchemeFns": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/kubernetes-incubator/apiserver-builder/pkg/builders.DefaultSchemeFns"),
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServiceBrokerSpec defines the desired state of ServiceBroker",
					Properties: map[string]spec.Schema{
						"url": {
							SchemaProps: spec.SchemaProps{
								Description: "url defines the address of a ServiceBroker service",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"name": {
							SchemaProps: spec.SchemaProps{
								Description: "name defines the name of a ServiceBroker service",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"username": {
							SchemaProps: spec.SchemaProps{
								Description: "username defines the username to access ServiceBroker service",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"password": {
							SchemaProps: spec.SchemaProps{
								Description: "password defines the password to access ServiceBroker service",
								Type:        []string{"string"},
								Format:      "",
							},
						},
					...
					Required: []string{"url", "name", "username", "password"},
				},
			},
			Dependencies: []string{},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServiceBrokerStatus defines the observed state of ServiceBroker",
					Properties: map[string]spec.Schema{
						"phase": {
							SchemaProps: spec.SchemaProps{
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerStatusStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"DefaultStatusStorageStrategy": {
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServiceBrokerStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"DefaultStorageStrategy": {
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlan": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServicePlan describe a ServicePlan",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
								Description: "name of a ServicePlan",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"id": {
							SchemaProps: spec.SchemaProps{
								Description: "id of a ServicePlan",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"metadata": {
							SchemaProps: spec.SchemaProps{
								Description: "metadata of a ServicePlan",
								Ref:         ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanMetadata"),
							},
						},
						"free": {
							SchemaProps: spec.SchemaProps{
								Description: "is this plan free or not",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
					},
					Required: []string{"name", "id", "description"},
				},
			},
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanMetadata"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanCost": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServicePlanCost describe a ServicePlanCost",
					Properties: map[string]spec.Schema{
						"amount": {
							SchemaProps: spec.SchemaProps{
								Description: "amount of a ServicePlanCost",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"unit": {
							SchemaProps: spec.SchemaProps{
								Description: "unit of a ServicePlanCost",
								Type:        []string{"string"},
								Format:      "",
							},
						},
		...
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanMetadata": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ServicePlanMetadata describe a ServicePlanMetadata",
					Properties: map[string]spec.Schema{
						"bullets": {
							SchemaProps: spec.SchemaProps{
								Description: "bullets of a ServicePlanMetadata",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
						...
						"costs": {
							SchemaProps: spec.SchemaProps{
								Description: "costs of a ServicePlanMetadata",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanCost"),
										},
									},
								},
							},
						...
						"displayName": {
							SchemaProps: spec.SchemaProps{
								Description: "displayname of a ServicePlanMetadata",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"customize": {
							SchemaProps: spec.SchemaProps{
								Description: "customize options of a plan.",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.CustomizeSpec"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.CustomizeSpec", "github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.ServicePlanCost"},
		},
		"github.com/asiainfoldp/apiserver-servicebroker/pkg/apis/prd/v1.UserProvidedService": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "UserProvidedService describe an user-provided-service",
					Properties: map[string]spec.Schema{
						"credentials": {
							SchemaProps: spec.SchemaProps{
								Type: []string{"object"},
