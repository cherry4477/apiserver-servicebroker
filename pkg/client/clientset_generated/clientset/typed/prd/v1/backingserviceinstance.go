...
type BackingServiceInstanceInterface interface {
	Create(*v1.BackingServiceInstance) (*v1.BackingServiceInstance, error)
	Update(*v1.BackingServiceInstance) (*v1.BackingServiceInstance, error)
	UpdateStatus(*v1.BackingServiceInstance) (*v1.BackingServiceInstance, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.BackingServiceInstance, error)
	List(opts meta_v1.ListOptions) (*v1.BackingServiceInstanceList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.BackingServiceInstance, err error)
...
func newBackingServiceInstances(c *PrdV1Client, namespace string) *backingServiceInstances {
...
func (c *backingServiceInstances) Get(name string, options meta_v1.GetOptions) (result *v1.BackingServiceInstance, err error) {
	result = &v1.BackingServiceInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *backingServiceInstances) List(opts meta_v1.ListOptions) (result *v1.BackingServiceInstanceList, err error) {
	result = &v1.BackingServiceInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) Create(backingServiceInstance *v1.BackingServiceInstance) (result *v1.BackingServiceInstance, err error) {
	result = &v1.BackingServiceInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) Update(backingServiceInstance *v1.BackingServiceInstance) (result *v1.BackingServiceInstance, err error) {
	result = &v1.BackingServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) UpdateStatus(backingServiceInstance *v1.BackingServiceInstance) (result *v1.BackingServiceInstance, err error) {
	result = &v1.BackingServiceInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *backingServiceInstances) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("backingserviceinstances").
...
func (c *backingServiceInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.BackingServiceInstance, err error) {
	result = &v1.BackingServiceInstance{}
