...
import (
	...
	fakeprdv1 "github.com/asiainfoldp/apiserver-servicebroker/pkg/client/clientset_generated/clientset/typed/prd/v1/fake"
...
func (c *Clientset) PrdV1() prdv1.PrdV1Interface {
	return &fakeprdv1.FakePrdV1{Fake: &c.Fake}
}

// Prd retrieves the PrdV1Client
