...
type Interface interface {
	...
	Prd() prdinternalversion.PrdInterface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	prd *prdinternalversion.PrdClient
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.prd, err = prdinternalversion.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.prd = prdinternalversion.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.prd = prdinternalversion.New(c)
