...
func GetAllControllers(config *rest.Config) ([]controller.Controller, chan struct{}) {
	...
	return []controller.Controller{
		backingservice.NewBackingServiceController(config, si),
		backingserviceinstance.NewBackingServiceInstanceController(config, si),
		servicebroker.NewServiceBrokerController(config, si),
	}, shutdown
}
