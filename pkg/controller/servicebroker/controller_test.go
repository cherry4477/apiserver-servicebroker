...
var _ = Describe("ServiceBroker controller", func() {
	var instance ServiceBroker
	var expectedKey string
	var client ServiceBrokerInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = ServiceBroker{}
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.PrdV1().ServiceBrokers()
